...
求人、企業、面接、プロフィール、スキルは PostgreSQL に永続化されます。ダッシュボード集計は現在サンプルデータです。
...
認証、求人ページネーション、企業、面接、プロフィール、スキル CRUD とマッチ度は実 API と接続済みです。残りはダッシュボード集計、URL 解析、日中表示の確認とデプロイです。
