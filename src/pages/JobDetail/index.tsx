      ...
      <section className="border-b border-[#211e25] pb-[22px] pt-1">
        ...
        <div className="mt-6 grid grid-cols-4 gap-px bg-[#211e25] max-[760px]:grid-cols-2">
          <div className="grid gap-2 bg-[#0c0b0e] p-[15px]">
            <span className="text-[9px] text-[#6f6977]">当前状态</span>
            <strong className={`status-badge status-${job.status}`}>
              {job.status}
            </strong>
          </div>
          <div className="grid gap-2 bg-[#0c0b0e] p-[15px]">
            <span className="text-[9px] text-[#6f6977]">技能匹配度</span>
            <strong className="text-[17px] text-[#2dd4bf]">{job.match}%</strong>
          </div>
          <div className="grid gap-2 bg-[#0c0b0e] p-[15px]">
            <span className="text-[9px] text-[#6f6977]">薪资范围</span>
            <strong className="text-xs">{job.salary}</strong>
          </div>
          <div className="grid gap-2 bg-[#0c0b0e] p-[15px]">
            <span className="text-[9px] text-[#6f6977]">最后更新</span>
          ...
          <section className={panelClass}>
            <div className="flex items-start justify-between gap-5">
              <div>
                ...
                <h3 className="mt-1 text-[15px] font-semibold">技能匹配分析</h3>
              </div>
          ...
          <section className={panelClass}>
            <div className="flex items-start justify-between gap-5">
              <div>
                ...
                <h3 className="mt-1 text-[15px] font-semibold">岗位备注</h3>
              </div>
              <Button
                className="h-auto p-0 text-[11px] text-[#a994df] hover:bg-transparent hover:text-[#d0c0f7]"
                variant="ghost"
          ...
          <section className={panelClass}>
            <div className="flex items-start justify-between gap-5">
              <div>
                ...
                <h3 className="mt-1 text-[15px] font-semibold">岗位来源</h3>
              </div>
            </div>
            <a
          ...
          <section className={panelClass}>
            <div className="flex items-start justify-between gap-5">
              <div>
                ...
                <h3 className="mt-1 text-[15px] font-semibold">状态记录</h3>
              </div>
                ...
                .map((status, index) => (
                  ...
                  >
                    ...
                    <p className="-mt-1 grid gap-[3px]">
                      <strong className="text-[11px]">{status}</strong>
